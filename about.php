...
<body>
    ...
    <section class="presentation">
        ...
        <div class="gif">
            <img alt="Gif of Geralt smiling" src="images/geralt-smile.gif">
        ...
        <div class="hobbies">
            ...
            <div class="roach">
                <img alt="Geralt and its horse Roach" src="images/ablette.jpg">
        ...
        <p>Comme vous l'avez pu deviner en lisant ces quelques lignes, ou en parlant à Jaskier, je suis un homme très altruiste.
        ...
        <p>L'un de mes projets est de concevoir un réseau social destiné aux sorceleurs.
            Ce projet aura pour but de faciliter la communication, partager de précieux conseils pour la chasse,
        ...
        <div class="gwent">
            <img alt="Geralt angry" src="images/geralt-angry.gif">
